...
from .openai_plugin_hostname import get_plugin_hostname
from .openai_plugin_routes import router as openai_plugin_router

# Get the hostname, which will vary depending on the environment
plugin_hostname = get_plugin_hostname()

app = FastAPI()
app.include_router(openai_plugin_router)
